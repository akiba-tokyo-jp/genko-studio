...
SOURCES = ["ops.py", "layerops.py", "threeops.py", "bookops.py", "fileops.py", "anim.py", "animops.py", "psd.py", "colour.py", "timelapse.py", "export.py", "rulers.py", "tones.py", "effects.py", "nombre.py", "models.py", "mannequin.py", "selection.py", "selops.py",
