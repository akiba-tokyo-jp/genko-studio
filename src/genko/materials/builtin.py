...
PRIMS = {
    "デッサン人形": (["人物", "人形", "ポーズ", "3D"], {"prim": "figure"}),
    "棒人形": (["人物", "人形", "ポーズ", "3D"], {"prim": "mannequin"}),
    "頭部": (["顔", "頭", "向き", "3D"], {"prim": "head"}),
    "手（ピース）": (["手", "指", "ピース", "3D"], {"prim": "hand", "pose": "peace"}),
    "手（握る）": (["手", "指", "こぶし", "3D"], {"prim": "hand", "pose": "fist"}),
    "手（開く）": (["手", "指", "パー", "3D"], {"prim": "hand", "pose": "open"}),
    "箱": (["箱", "建物", "3D"], {"prim": "box"}),
